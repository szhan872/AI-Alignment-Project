...
from helm.general import match_case, ensure_file_downloaded
from helm.perturbation_description import PerturbationDescription
from helm.perturbation import TextPerturbation
...
class DialectPerturbation(TextPerturbation):
    ...
    def __init__(self, prob: float, source_class: str, target_class: str, mapping_file_path: Optional[str] = None):
        ...
        self.pattern = r'\b(' + '|'.join(re.escape(word) for word in self.mapping_dict.keys()) + r')\b'
