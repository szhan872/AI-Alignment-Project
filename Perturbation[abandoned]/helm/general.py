...
from helm.hierarchical_logger import hlog, htrack, htrack_block
from helm.optional_dependencies import handle_module_not_found_error
...
def match_case(word, replacement):
    """Match the case of the replacement word to the original word."""
    if word.isupper():
